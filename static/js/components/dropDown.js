 ...
 */
function renderDropDwon(drop_down_data, DDtitle) {
    ...
    const drop_down_select = `<div class="dropDownMsg"><select class="browser-default dropDownSelect"> <option value="" disabled selected>${DDtitle}</option>${drop_down_options}</select></div>`;
